...
export default function Home() {
    return (
        <div>
            ...
            <header className="py-5 bg-image-full" style={{ backgroundImage: "url('https://maps.prodafrica.com/wp-content/uploads/2018/08/6374_MECA_001.jpg')" }}>
                <div className="text-center my-5">
                    <img className="img-fluid rounded-circle mb-4" src="/logo192.png" width={100} alt="..." />
                    <h1 className="text-white fs-3 fw-bolder">Impact Report</h1>
                    <p className="text-white-50 mb-0">The Elgon Region</p>
                </div>
            </header>
